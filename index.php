                ...
                <div id="wrapper-footer">
                    <div id="content-footer">
                        <div id="footer">
                            ...
                            Others: interface by <strong>Sun</strong>, props to <strong>[zG]Woods</strong>, champion numbers by <strong>Hobbesclone</strong> and skin numbers <strong>Viitrexx</strong>.<br>
